...
public struct HealthManagerFontConvertible {
...
public extension HealthManagerFontConvertible.Font {
  convenience init?(font: HealthManagerFontConvertible, size: CGFloat) {
